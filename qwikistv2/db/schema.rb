...
ActiveRecord::Schema.define(version: 20170516121704) do
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["agreement_id"], name: "index_sessions_on_agreement_id", using: :btree
    t.index ["gym_id"], name: "index_sessions_on_gym_id", using: :btree
  end
  ...
  add_foreign_key "sessions", "agreements"
